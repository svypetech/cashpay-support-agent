        ...
        <table className="w-full text-left min-w-[1000px] border-separate border-spacing-y-2">
          <thead>
            <tr className="bg-secondary/10 text-[12px] sm:text-[16px]">
              ...
              <th className="p-4 text-left font-[700] text-[16px] w-[25%]">
                {headings[3]}
              </th>
              <th className="p-4 text-left font-[700] text-[16px] w-[25%]">
                {headings[4]}
            ...
            {Array.isArray(data) &&
              data.map((apiLog, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  {/* Request ID */}
                  <td className="p-4 text-[12px] font-[400] text-secondaryText">
                    {apiLog.requestID}
                  </td>
                  
                  {/* Endpoint */}
                  <td className="p-4 font-[400]">
                    <span 
                      className="bg-secondary/10 text-primary px-4 py-2 rounded inline-block text-[12px] max-w-fit"
                  ...
                  {/* Timestamp */}
                  <td className="p-4 font-[400] text-[16px] text-secondaryText">
                    {apiLog.timestamp}
                  </td>
